...
def plot_results(train_df, test_df, forecast, conf_int):
    ...
    ax1.plot(test_df['date'], forecast, label='ARIMA Forecast', 
    ...
    ax1.set_title('ARIMA Bitcoin Price Forecast - Full Timeline', 
    ...
    ax2.plot(test_df['date'], forecast, label='ARIMA Forecast', 
    ...
    ax2.set_title('ARIMA Forecast - Detailed View (Last 60 Days + 30-Day Forecast)', 
                  fontsize=13, fontweight='bold', pad=15)
